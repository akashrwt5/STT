...
final class SemanticClassifier {
    ...
    init?() {
        ...
        if let modelURL = Bundle.module.url(forResource: "SemanticHead", withExtension: "mlpackage")
                       ?? Bundle.module.url(forResource: "SemanticHead", withExtension: "mlmodelc"),
        ...
        guard
            let url  = Bundle.module.url(forResource: "semantic_head", withExtension: "json"),
