...
public actor MultilingualIntentClassifierService: IntentClassifying {
    ...
    private let logger = Logger(subsystem: "com.voiceintentkit", category: "MultilingualIntentClassifier")
    ...
    public init(language: String = "multilingual") {
        ...
        let intentURL =
            Bundle.module.url(forResource: "IntentClassifier_multilingual",
        ...
        if let modelURL = intentURL {
            ...
            coreMLModel = nil
            Logger(subsystem: "com.voiceintentkit", category: "MultilingualIntentClassifier")
        ...
        let calURL = Bundle.module.url(forResource: "calibration", withExtension: "json",
                                     subdirectory: Self.resourceSubdir)
