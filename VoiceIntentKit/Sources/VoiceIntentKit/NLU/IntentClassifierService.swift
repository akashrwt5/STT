...
public actor IntentClassifierService: IntentClassifying {
    ...
    private let logger = Logger(subsystem: "com.voiceintentkit", category: "IntentClassifier")
    ...
    public init() {
        ...
        let intentURL = Bundle.module.url(forResource: "IntentClassifier", withExtension: "mlmodelc")
                     ?? Bundle.module.url(forResource: "IntentClassifier", withExtension: "mlpackage")
        ...
        let jsonURL = Bundle.module.url(forResource: "intent_classifier_weights",
                                      withExtension: "json")
        guard
            let url  = jsonURL,
        ...
        Logger(subsystem: "com.voiceintentkit", category: "IntentClassifier")
    ...
    private func logitsForScoring(_ text: String) -> [Double] {
        ...
        // visible in Console.app (filter by subsystem com.voiceintentkit, category IntentClassifier).
