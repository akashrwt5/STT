...
/*
 ...
 It is NOT part of the VoiceIntentKit SDK and will not be compiled into it.
...
/// A reference manager demonstrating how the Host App coordinates the backend API and the VoiceIntentKit SDK.
