...
/// Enforces backward and forward compatibility between the OTA package and the VoiceAIKit SDK.
...
public struct EngineCompat: Codable, Equatable {
    /// The minimum version of VoiceAIKit's inference engine required to run this pack.
