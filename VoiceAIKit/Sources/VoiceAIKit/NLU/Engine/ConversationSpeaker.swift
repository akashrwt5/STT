...
final class ConversationSpeaker: NSObject, AVSpeechSynthesizerDelegate {
    ...
    private static let speechQueue = DispatchQueue(label: "com.voiceaikit.tts", qos: .userInitiated)
    ...
    // delay. Filter Console.app / `log stream` by subsystem com.voiceaikit,
    // category Latency.
    private static let latencyLog = Logger(subsystem: "com.voiceaikit", category: "Latency")
    private let logger = Logger(subsystem: "com.voiceaikit", category: "ConversationSpeaker")
