...
final class TranscriptionCoordinator {
    ...
    private let logger = Logger(subsystem: "com.voiceaikit", category: "TranscriptionCoordinator")
    /// TTS-latency teardown breakdown. Filter by subsystem com.voiceaikit, category
    /// Latency. Logging only — no behaviour change.
    private let latencyLog = Logger(subsystem: "com.voiceaikit", category: "Latency")
